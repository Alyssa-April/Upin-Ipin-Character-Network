...
details <- read_excel("C:/Users/User/Desktop/PhD Year 1/Upin Ipin/Film Stats.xlsx",
...
relay_details <- read_excel("C:/Users/User/Desktop/PhD Year 1/Upin Ipin/Film Stats.xlsx", sheet = 4) # load Excel sheet of nodes and relationships
...
# read edge list 
edges <- read_excel("C:/Users/User/Desktop/PhD Year 1/Upin Ipin/Film Stats.xlsx", sheet = "Final")
  
# read node details
nodes <- read_excel("C:/Users/User/Desktop/PhD Year 1/Upin Ipin/Film Stats.xlsx", sheet = "Details")
...
# read edge list 
edges_dir <- read_excel("C:/Users/User/Desktop/PhD Year 1/Upin Ipin/Film Stats.xlsx", sheet = "Undirected")
...
movie_deg <- degree(movie_adj, rescale = TRUE)
...
role_df_corr <- role_df

png("Fig2(b).png", width = 6.85, height = 6, units = "in", res = 1200, family = "Helvetica")
...
ggplot(role_df, aes(x = Name, y = Degree, color = Role, shape = Role, group = 1)) +
  ...
  annotate("text", x = length(role_df$Name)/2 + 4, y = avg_deg + 0.005, label = "Average Degree", color = "black", size = 4.2) +  # label for avg degree
  annotate("text", x = max_gap + 1.8, y = max(role_df$Degree) - 0.012, label = "Largest \nGap", color = "black", size = 4.2, angle = 270) +  # label for largest gap
...
png("Fig7(b).png", width = 6.85, height = 6, units = "in", res = 1200, family = "Helvetica")
...
ggplot(role_df, aes(x = Name, y = Degree, color = Role, shape = Role, group = 1)) +
  ...
  geom_vline(xintercept = max_gap + 0.5, linetype = "dotted", color = "darkgrey", size = 1) +  # largest gap line
  annotate("text", x = length(role_df$Name)/2 + 7, y = avg_deg_unw_und + 0.006, label = "Average Degree \n(Unweighted & Undirected)", color = "black", size = 4.2) +  # label for avg degree
  annotate("text", x = max_gap + 1.8, y = max(role_df$Degree) - 0.028, label = "Largest \nGap", color = "black", size = 4.2, angle = 270) +  # label for largest gap
  scale_color_manual(values = c("green", "blue", "red")) +  # colours for Major, Minor, Extra
  scale_shape_manual(values = c(16, 17, 15)) +
...
png("Fig7(d).png", width = 6.85, height = 6, units = "in", res = 1200, family = "Helvetica")
...
ggplot(role_df, aes(x = Name, y = Eigenvector, color = Role, shape = Role, group = 1)) +
  ...
  geom_vline(xintercept = max_gap + 0.5, linetype = "dotted", color = "darkgrey", size = 1) +  # largest gap line
  annotate("text", x = length(role_df$Name)/2 + 6, y = avg_ev + 0.035, label = "Average Eigenvector", color = "black", size = 4.2) +  # label for avg ev
  annotate("text", x = max_gap + 1.2, y = max(role_df$Eigenvector) - 0.15, label = "Largest Gap", color = "black", size = 4.2, angle = 270) +  # label for largest gap
  scale_color_manual(values = c("green", "blue", "red")) +  # colours for Major, Minor, Extra
  scale_shape_manual(values = c(16, 17, 15)) +
  theme_minimal(base_family = "Helvetica") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 12),
...
png("Fig7(f).png", width = 6.85, height = 6, units = "in", res = 1200, family = "Helvetica")
...
ggplot(role_df, aes(x = Name, y = Betweenness, color = Role, shape = Role, group = 1)) +
  ...
  geom_vline(xintercept = max_gap + 0.5, linetype = "dotted", color = "darkgrey", size = 1) +  # largest gap line
  annotate("text", x = length(role_df$Name)/2 + 1, y = avg_btwn + 2, label = "Average Betweenness", color = "black", size = 4.2) +  # label for avg btwn
  annotate("text", x = max_gap + 1.15, y = max(role_df$Betweenness) - 17, label = "Largest Gap", color = "black", size = 4.2, angle = 270) +  # label for largest gap
  scale_color_manual(values = c("green", "blue", "red")) +  # colours for Major, Minor, Extra
  scale_shape_manual(values = c(16, 17, 15)) +
  theme_minimal(base_family = "Helvetica") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, size = 12),
...
png("Fig7(h).png", width = 6.85, height = 6, units = "in", res = 1200, family = "Helvetica")
...
ggplot(role_df, aes(x = Name, y = Closeness, color = Role, shape = Role, group = 1)) +
  ...
  geom_vline(xintercept = max_gap + 0.5, linetype = "dotted", color = "darkgrey", size = 1) +  # largest gap line
  annotate("text", x = length(role_df$Name)/2 + 6.5, y = avg_closeness + 0.001, label = "Average Closeness", color = "black", size = 4.2) +  # label for avg closeness
  annotate("text", x = max_gap + 1.8, y = max(role_df$Closeness) + 0.0015, label = "Largest \nGap", color = "black", size = 4.2, angle = 270) +  # label for largest gap
  scale_color_manual(values = c("green", "blue", "red")) +  # colours for Major, Minor, Extra
  scale_shape_manual(values = c(16, 17, 15)) +
...
null_degrees <- matrix(NA, nrow = vcount(giant_comp_undirected), ncol = num_sims)
null_betweenness <- matrix(NA, nrow = vcount(giant_comp_undirected), ncol = num_sims)
null_closeness <- matrix(NA, nrow = vcount(giant_comp_undirected), ncol = num_sims)
null_eigen <- matrix(NA, nrow = vcount(giant_comp_undirected), ncol = num_sims)
...
centrality_df <- data.frame(
    Name = V(giant_comp_undirected)$name,
